...
#'   object which contains the DNA sequence that is used for the GC correction or RRBS correction.
...
#'   separately.
#' @param rrbs A logical indicating whether the data comes from Reduced representaion
